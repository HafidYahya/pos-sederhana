        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/src/img/<?=$_SESSION["profile_image"]?>" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="dashboard.php" class="d-block"><?= $_SESSION["username"] ?></a>
                    </div>
                </div>
                <?php else: ?>
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/profile_default.webp" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                        <a href="dashboard.php" class="d-block"><?= $_SESSION["username"] ?></a>
                    </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="assets/pages/tables/data.php" class="nav-link">
